...
const IndexScreen = ({ navigation }) => {
    const [request, googleResponse, promptAsync] = Google.useIdTokenAuthRequest({
        clientId: "1013744309561-i48rf6f03b7ueb637huticdbuergsuuq.apps.googleusercontent.com",
    });
    ...
    return ( <
        ...
        /Text> <
        /Center> <
        Ionicons.Button name = "ios-logo-google"
        iconStyle = {
            { marginLeft: 52 } }
        height = { 48 }
        width = "100%"
        ...
        Sign in with Google <
        /Ionicons.Button> <
        Ionicons.Button name = "ios-logo-facebook"
        iconStyle = {
            { marginLeft: 51 } }
        height = { 48 }
        width = "100%"

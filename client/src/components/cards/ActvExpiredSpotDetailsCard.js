...
const ActvExpiredSpotDetailsCard = ({
  item,
  currentDate,
  type,
  navigation,
              ...
              {type === "hostReservation" || type === "hostArchive" ? (
                ...
                <Box>
                  <VStack space={2}>
                    ...
                    <HStack space={4} mb={4}>
                      <VStack>
                        <Text fontSize={14}>{item.paOwnerId && item.paOwnerId}</Text>
...
export default ActvExpiredSpotDetailsCard;

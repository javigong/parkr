...
const ParkingStack = () => {
  return (
    <Stack.Navigator>
      <Stack.Screen name="ConfirmDateTimeScreen" component={ConfirmDateTimeScreen} />
      <Stack.Screen name="WhoParksScreen" component={WhoParksScreen } />
      <Stack.Screen name="AvailableTodayScreen" component={AvailableTodayScreen} />
      ...
      <Stack.Screen name="ConfirmReservationScreen" component={ConfirmReservationScreen} />
